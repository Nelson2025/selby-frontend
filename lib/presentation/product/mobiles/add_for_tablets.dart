/*This is the Add New Mobile Tablets Screen*/
...
class AddForTabletsScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForTabletsScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForTabletsScreen> createState() => _AddForTabletsScreenState();
}

class _AddForTabletsScreenState extends State<AddForTabletsScreen> {
  List<File> images = [];
