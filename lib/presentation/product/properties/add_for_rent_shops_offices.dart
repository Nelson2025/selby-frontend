/* This is Add New Properties - For Rent: Shops & offices Screen*/
...
class AddForRentShopsOfficesScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForRentShopsOfficesScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForRentShopsOfficesScreen> createState() =>
      _AddForRentShopsOfficesScreenState();
}

class _AddForRentShopsOfficesScreenState
    extends State<AddForRentShopsOfficesScreen> {
  List<File> images = [];
