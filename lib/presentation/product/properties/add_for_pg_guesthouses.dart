/* This is Add New Properties - PG & Guest Houses Screen*/
...
class AddForPgGuestHousesScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForPgGuestHousesScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForPgGuestHousesScreen> createState() =>
      _AddForPgGuestHousesScreenState();
}

class _AddForPgGuestHousesScreenState extends State<AddForPgGuestHousesScreen> {
  List<File> images = [];
            ...
            child: Column(
              children: [
                ...
                PrimaryDropdownButton(
                  ...
                  dropdownValue: subtypeController,
                  brand: subtypeList,
                  onChanged: (val) {
                    setState(() {
                      subtypeController = val!;
                    });
                  },
                ),
                const GapWidget(),
  ...
  Future<void> _submit(BuildContext context) async {
    ...
    FormData formData = FormData.fromMap({
      ...
      'userId': userId,
      'features': {
        'subtype': subtypeController.trim(),
