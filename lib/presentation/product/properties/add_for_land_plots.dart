/* This is Add New Properties - Land & plots Screen*/
...
class AddForLandPlotsScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForLandPlotsScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForLandPlotsScreen> createState() => _AddForLandPlotsScreenState();
}

class _AddForLandPlotsScreenState extends State<AddForLandPlotsScreen> {
  List<File> images = [];
