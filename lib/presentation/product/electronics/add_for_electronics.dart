/*This is the Add New Electronics Screen*/
...
class AddForElectronicsScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForElectronicsScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForElectronicsScreen> createState() =>
      _AddForElectronicsScreenState();
}

class _AddForElectronicsScreenState extends State<AddForElectronicsScreen> {
  List<File> images = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(
              "Add New ${widget.subcategory == '' ? widget.category.title : widget.subcategory}"),
        ),
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                const GapWidget(),
                const Text(
                  "Maximum 8 photos you can upload",
