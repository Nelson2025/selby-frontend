/* This is Add New Bikes Bicycles Screen*/
...
class AddForBicyclesScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForBicyclesScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForBicyclesScreen> createState() => _AddForBicyclesScreenState();
}

class _AddForBicyclesScreenState extends State<AddForBicyclesScreen> {
  List<File> images = [];
