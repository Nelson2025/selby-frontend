/* This is Add New Bikes Spareparts Screen*/
...
class AddForSparepartsScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForSparepartsScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForSparepartsScreen> createState() => _AddForSparepartsScreenState();
}

class _AddForSparepartsScreenState extends State<AddForSparepartsScreen> {
  List<File> images = [];
