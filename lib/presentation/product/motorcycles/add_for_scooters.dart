/* This is Add New Bikes Scooters Screen*/
...
class AddForScootersScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForScootersScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForScootersScreen> createState() => _AddForScootersScreenState();
}

class _AddForScootersScreenState extends State<AddForScootersScreen> {
  List<File> images = [];
