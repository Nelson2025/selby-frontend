/* This is Add New Bikes Motorcycles Screen*/
...
class AddForMotorcyclesScreen extends StatefulWidget {
  final dynamic category;
  final dynamic subcategory;
  final String city;
  final String state;
  final String country;
  const AddForMotorcyclesScreen(
      {super.key,
      this.category,
      this.subcategory,
      required this.city,
  ...
  @override
  State<AddForMotorcyclesScreen> createState() =>
      _AddForMotorcyclesScreenState();
}

class _AddForMotorcyclesScreenState extends State<AddForMotorcyclesScreen> {
  List<File> images = [];
